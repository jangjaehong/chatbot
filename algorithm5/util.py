...
class DataUtil:
    ...
    def __init__(self):
        ...
        self.enc_vocab, self.enc_reverse_vocab, self.enc_vocab_size, self.max_encoder_len = self.build_vocab(all_input_sentences)
        self.dec_vocab, self.dec_reverse_vocab, self.dec_vocab_size,  self.max_decoder_len = self.build_vocab(all_target_sentences, is_target=True)
